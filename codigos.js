...
const codes = {
  "10-00": {
    ...
    details:
      "Indica que se debe proceder con precaución. Utilizado en situaciones donde hay potencial de peligro.",
  },
  "10-03": {
    description: "Información sobre algo",
    details:
      "Se utiliza para solicitar o proporcionar información adicional sobre un tema específico.",
  },
  "10-04": {
    description: "Afirmativo",
    details:
      "Confirma que un mensaje ha sido recibido y entendido correctamente.",
  },
  "10-05": {
    description: "Negativo",
    details:
      "Indica que la respuesta a una pregunta es negativa o que una acción no puede ser realizada.",
  },
  "10-06": {
    description: "Parada de tráfico",
    details:
      "Se refiere a una parada de tráfico rutinaria para inspección o verificación.",
  },
  "10-08": {
    description: "Esperando Asignación",
    details:
      "Indica que una unidad está disponible y esperando una nueva asignación.",
  },
  "10-09": {
    description: "Repetir último mensaje",
    details:
      "Solicita la repetición del último mensaje debido a que no fue comprendido o escuchado claramente.",
  },
  "10-10": {
    description: "Fin del servicio",
    details:
      "Indica que una unidad ha finalizado su servicio y no está disponible para nuevas asignaciones.",
  },
  "10-11": {
    description: "Comunicación más lenta",
    details:
      "Solicita que la comunicación sea más lenta para mejor comprensión.",
  },
  "10-14": {
  ...
  "10-25": {
    ...
    details:
      "Indica que un detenido está siendo trasladado a una ubicación específica.",
  },
  "10-37": {
  ...
  "10-95": {
    ...
    details:
      "Indica que un sujeto está siendo procesado, generalmente para arresto o detención.",
  },
  "10-97": {
  ...
  148: {
    ...
    details:
      "Se refiere a una situación donde un sujeto está resistiendo activamente al arresto.",
  },
  "254 Victor": {
    description: "Persecución en vehículo",
    details: "Informa de una persecución a un vehículo de un sospechoso.",
  },
  147: {
  ...
  "254 Paul": {
    ...
    details:
      "Específicamente designado para una persecución a pie de un sospechoso.",
  },
  415: {
  ...
  444: {
    ...
    details:
      "Informa que un agente está en peligro y necesita asistencia inmediata.",
  },
  459: {
  ...
  QRR: {
    ...
    details:
      "Informa que se ha activado un botón de pánico, indicando una emergencia.",
  },
  "Código 1": {
  ...
  "Código 3": {
    ...
    details:
      "Se utiliza en situaciones que requieren máxima prioridad y respuesta urgente.",
  },
  "Código 4": {
  ...
  "Código 4 ADAM": {
    ...
    details:
      "Indica que no se tiene visual del incidente y se retoma el patrullaje normal.",
  },
  "Código 5": {
  ...
  "Código 7": {
    ...
    details:
      "Indica una parada técnica por razones específicas como mantenimiento o descanso.",
  },
  "Código 8": {
  ...
  "Código 9": {
    ...
    details:
      "Indica que hay un sujeto buscado activamente por las autoridades.",
  },
  "Código 9 ADAM": {
    description: "Sujeto peligroso en búsqueda y captura",
    details:
      "Se refiere a un sujeto peligroso que está siendo buscado activamente.",
  },
  "Código 10": {
  ...
  "Código 11": {
    ...
    details:
      "Solicita o proporciona una actualización sobre la situación actual.",
  },
  "Código 12": {
  ...
  "Código 37": {
    ...
    details:
      "Se utiliza para indicar que un vehículo ha sido reportado como robado.",
  },
  "Código 100": {
  ...
  "CLAVE PIT": {
    ...
    details:
      "Permiso para realizar una maniobra de PIT para detener un vehículo.",
  },
  "TOM CHARLES": {
  ...
  5150: {
    ...
    details:
      "Indica la presencia de una persona con problemas mentales que puede necesitar atención.",
  },
  517: {
...
const allCodes = Object.entries(codes).map(
...
document.getElementById("codeFilter").addEventListener("change", function () {
  ...
  if (value === "all") {
    ...
    filteredCodes = allCodes.filter(
      (codigo) =>
        codigo.code.startsWith("Código") ||
        codigo.code.startsWith("CLAVE") ||
        codigo.code.startsWith("TOM") ||
        codigo.code.startsWith("QRR") ||
        codigo.code.startsWith("API") ||
        codigo.code.startsWith("PC") ||
        codigo.code.startsWith("CI")
    );
  } else if (value === "other") {
    filteredCodes = allCodes.filter(
      (codigo) => !codigo.code.startsWith("Código") &&
      !codigo.code.startsWith("CLAVE") &&
      !codigo.code.startsWith("TOM") &&
      !codigo.code.startsWith("QRR") &&
      !codigo.code.startsWith("API") &&
...
let currentCodes = allCodes; // Inicialmente, todos los códigos se muestran
...
searchInput.addEventListener('input', () => {
  ...
  for (const code of currentCodes) {
    if (
      removeAccentsAndNonAlphanumeric(code.code.toUpperCase()).includes(searchTerm) ||
      removeAccentsAndNonAlphanumeric(code.description.toUpperCase()).includes(searchTerm) ||
      removeAccentsAndNonAlphanumeric(code.details.toUpperCase()).includes(searchTerm)
    ) {
      results.push(code);
    }
  }
